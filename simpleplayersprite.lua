...
local image_w = 512 --This info can be accessed with a Löve2D call
local image_h = 512 --		after the image has been loaded. I'm creating these for readability.

return {
   serialization_version = 1.0, -- The version of this serialization process

   sprite_sheet = "images/spritesheet_players.png", -- The path to the spritesheet
   ...
   animations = {
	 ...
	 love.graphics.newQuad( 156, 101, 45, 54, image_w, image_h )
      },
